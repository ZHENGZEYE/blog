 ...
 * @date 2022年08月19日
 */
//在我们的真是开发中，或者你们在公司，一般都可以看到一个公司自己封装的RedisUtil
@Component
public final class RedisUtil {
     ...
     * 通过索引 获取list中的值
     * @param key 键
     * @param index 索引index>=0时，0 表头，1第二个元素，以此类推；index<0时，-1 表尾，-2倒数第二个元素，一次类推
     * @return
     */
